...
def login(usuario):
    try:
        ...
        return error_response(
            error=str(e), message="Usuario no encontrado", status_code=404
        )
...
def logout():
    ...
    try:
        ...
        return error_response(
            error=str(e), message="Error al cerrar sesión", status_code=500
        )
...
def register(usuario):
    ...
    try:
        ...
        return error_response(
            error=str(e), message="El correo ya está registrado", status_code=409
        )
        ...
        return error_response(
            error=str(e), message="Error al registrar usuario", status_code=500
        )
...
def request_password_reset(usuario):
    ...
    try:
        ...
        return error_response(
            error=str(e), message="Error al solicitar recuperación", status_code=500
        )
...
def verify_reset_code(usuario, code):
    ...
    try:
        ...
        return error_response(
            error=str(e), message="Error al verificar código", status_code=500
        )
...
def reset_password(usuario, code):
    ...
    try:
        ...
        return error_response(
            error=str(e), message="Error al restablecer contraseña", status_code=500
        )
...
def verify_email():
    ...
    try:
        ...
        return error_response(
            error=str(e), message="Error al verificar correo", status_code=500
        )
...
def pre_register(usuario):
    ...
    try:
        ...
        return error_response(
            error=str(e), message="Error en pre-registro", status_code=500
        )
...
def register2(userData, code):
    ...
    try:
        ...
        return error_response(
            error=str(e), message="Error al completar registro", status_code=500
        )
...
def get_perfil():
    ...
    try:
        ...
        return error_response(
            error=str(e), message="Error al obtener el perfil", status_code=500
        )
...
def cambiar_contrasenia():
    try:
        ...
        if not contasenia_actual or not nueva_contrasenia:
            return error_response(
                error="Faltan campos",
                message="Contraseña actual y nueva son campos obligatorios",
                status_code=400,
            )
        ...
        return error_response(
            error=str(e), message="Usuario no encontrado", status_code=400
        )
    except Exception as e:
        print("Error", traceback.format_exc())
        return error_response(
            error=str(e), message="Error al cambiar la contraseña", status_code=500
        )
